...
$query = "SELECT `id`, `fullname`, `nic`, `dob`, `address1`, `address2`, `address3`, `type`, `telephone_no`, `email`, `image_path` FROM `registered_trainee` WHERE `id`=".$_GET['tr_id'];

//echo ($query);


$data_array=$obj->getResultArray($query);
...
<html>
    ...
    <body>
        <?php require_once './include/navbar_profile.php'; ?>
...
<!--                        <table class="table table-hover table-bordered" id="tbl_profileimage" s >
                    ...
                    <?php echo ' <img id="profileimgLoad" src="database/upload/'.$value["image_path"].'" alt="" class="img-thumbnail" /> '; ?>
                    </div>
                    <div class="col-md-9">                   
                    </div>
                </div>
                            ...
                            <div class="col-md-3">
                                <div class="card bg-light mb-3" style="width: 400px;">
                                    ...
                                    <div class="card-body row" style="height: 40px">
                                        ...
                                        <div class="col-sm-40">                                       
                                            <input type="text" readonly class="form-control-plaintext" id="staticFullname" value="<?php echo $value['fullname']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body row" style="height: 40px">
                                        ...
                                        <div class="col-sm-40">                                        
<input type="text" readonly class="form-control-plaintext" id="staticNIC" value="<?php echo $value['nic'];?>">
                                        </div>
                                    </div>
                                    <div class="card-body row" style="height: 40px">
                                        <label for="staticDOB" class="col-sm-4 col-form-label" >DOB:</label>
                                        <div class="col-sm-40">                                       
                                            <input type="text" readonly class="form-control-plaintext" id="staticDOB" value="<?php echo $value['dob']; ?>">
                                        </div>
                                    </div>
                                    <div class="card-body row" style="height: 40px">
                                        <label for="staticAddress1" class="col-sm-4 col-form-label" >Address1:</label>
                                        <div class="col-sm-40">                                       
                                            <input type="text" readonly class="form-control-plaintext" id="staticAddress1" value="<?php echo $value['address1']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body row" style="height: 40px">
                                        ...
                                        <div class="col-sm-40">
                                            <input type="text" readonly class="form-control-plaintext" id="staticAddress2" value="<?php echo $value['address2']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body row" style="height: 40px">
                                        ...
                                        <div class="col-sm-40">
                                            <input type="text" readonly class="form-control-plaintext" id="staticAddress3" value="<?php echo $value['address3']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-sm-40">
                                            <input type="text" readonly class="form-control-plaintext" id="staticPosition" value="<?php echo $value['type']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="uploadimage" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div id="message"></div>
                                                <div id="selectImage">                                                  
                                                    <input type="hidden" name="profUserID"  value=" <?php echo ($_SESSION['user_id']); ?>" />                                                   
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="card bg-light mb-3" style="width: 400px; height: 200px">
                                    ...
                                    <div class="card-body row" style="height: 40px">
                                        ...
                                        <div class="col-sm-40">
                                            <input type="text" readonly class="form-control-plaintext" id="staticTelephoneno1" value="<?php echo $value['telephone_no']; ?>">
                                        </div>
                                    </div>                                
                                    <div class="card-body row">
                                        <label for="staticEmail" class="col-sm-4 col-form-label" >Email:</label>
                                        <div class="col-sm-40">
                                            <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo $value['email'];} ?>">
                                        </div>
                                    </div>  
                                </div>
                            </div>
                            ...
                            <!--                            <div class="col-md-3">
                                                            <div class="card bg-light mb-3" style="width: 200px; height: 200px">
                                                               ...
                                                               <div class="card-body">
                                                                    ...
                                                                    <br/>
                                                                    <br/>
                                                                    <button type="button" class="btn btn-primary" id="sendMessage" onclick="window.location.href = 'ViewRequest.php';">Send Message</button>
                                                                </div>
                                                            </div>
                                                        </div>-->
                        </div>
