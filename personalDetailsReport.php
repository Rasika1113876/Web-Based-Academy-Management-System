...
<html>
        ...
        <div class="row">
            <div class="col-md-12 row">
                ...
                <div class="col-md-8">
                    ...
                    <br>
                    <div class="col-md-12" style="background-color:black;"><font style="font-weight: bolder; color: white; font-size:24px; margin-left: 300px;">TRAINEE PERSONAL DETAILS REPORT</font></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8"> 
                ...
                <div class="col-md-2"style="margin-top: 10px;">
                    <button type="button" class="btn btn-primary " id="printreportpersonal" style="margin-left: 0px; width: 113px;"><img src='svg/Print01.svg' width='35' height='30'>&nbsp;PRINT REPORT </button>
                </div> 
        </div>
    </body>
    ...
    <script type =text/javascript>
        ...
        $('#printreportpersonal').click(function () {
            window.print();
        });
