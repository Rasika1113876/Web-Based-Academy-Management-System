...
<!--                        <table class="table table-hover table-bordered" id="tbl_profileimage" s >
                    ...
                    <div class="col-md-9"> 
                        <form class="form-inline" style="margin-left: 550px">
                            <input class="form-control mr-sm-2" id="searchID" type="search" placeholder="Search Profile" aria-label="Search">
                            <button class="btn btn-primary my-2 my-sm-0" type="button" id="searchprofile" >Search</button>
                        </form>
                    </div>
                </div>
                <!--end row 1-->
...
<!--                                            <input type="button" value="Reload Page" onClick="document.location.reload(true)">-->
                            ...
                            <div class="col-md-3">
                                <div class="card bg-light mb-3" style="width: 200px; height: 200px">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <br/>
                                        <br/>
                                        <button type="button" class="btn btn-primary" id="sendMessage" onclick="window.location.href = 'ViewRequest_trainee.php';">Send Message</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type =text/javascript>
                                            ...
                                            $('#searchprofile').click(function () {
                                                ...
                                                //
                                                //  onclick=""
                                                window.location.href = 'userProfileCommon.php?tr_id=' + $('#searchID').val();
                                            });                                          
