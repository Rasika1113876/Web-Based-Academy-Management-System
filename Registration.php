                    ...
                    <form class="col-md-12 row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div>                                        
                                    <select class="form-control " id="u_typ" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="u_nic" name="nic" maxlength="12" placeholder="Enter NIC Number" >
...
////begin of nic validation 12 numbers
                                    $('#u_nic').on('keyup', function () {
                                        var nic_no = document.getElementById('u_nic').value;
                                        if (/^[0-9]{12}$/.test(nic_no) || nic_no.length < 1) {
                                            $('#nic_val').html('');
                                            $('#nic_valok').html('<i class="glyphicon glyphicon-ok-sign"></i> Valid NIC number.');
                                            $('#btn_signUp').removeClass('d-none');
                                        } else {
...
////end of nic validation 12 numbers
