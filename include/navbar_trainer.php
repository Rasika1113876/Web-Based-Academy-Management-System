            ...
            <ul class="navbar-nav" style="width: 1000px;">
                ...
                <li class="nav-item">
                    ...
                    <div class="row" style="margin-left: 200px; width: 500px;" >
                        <font style="align-items: center; color: #ffffff; font-weight: bolder; font-size:35px; font-family: serif;" >TRAINER DASHBOARD</font>
                    </div>
                </li>  
                <li>
                    <div class="row" style="margin-left: 300px; margin-top: 25px;" >
                        <form class="navbar-form" action="">
                            <div class="form-group" style="color: white;">
                                <label for="Cid" style="color: white; font-family: serif;">You are logged in as <font style="color: #ffffff;">TRAINER</font></label>
                                <br>
                ...
                <li>
                    ...
                    <button type='button' class='btn btn-secondary btnLogout' value='<?php echo ($_SESSION['user_id']); ?>' id="LogOut"><img src="svg/logout.svg" width="20" height="20"></button>
                     ...
                     <li>
                    <div class="row" style="margin-left: 25px; margin-top: 40px;" >
                        <button class="btn" style="background-color: #808083; height:35px" onclick="window.location.href = 'TrainerDashboard.php';"><img src='svg/si-glyph-arrow-backward.svg' width='35' height='30'></button>
                    </div>                    
                    </li>
            </ul>
        </div>
